# ------------------------------------------------------------------------------
# Reference: https://github.com/timbroed/MUSES/blob/master/processing/event_camera_processing.py
# ------------------------------------------------------------------------------
...
from .utils import enlarge_points_in_image, rescale_K
...
def load_event_camera_projection(event_path, calib_data, target_shape=(1920, 1080), 
                                 enlarge_event_camera_points=False, dialtion_kernal=(2, 2)):
    """
